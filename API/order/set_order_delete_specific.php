...
$payment_query = mysqli_query($db_link, "SELECT `B01N03MM` FROM `b01` WHERE `B01I04XA` = '$table_uuid' AND `B01N04IT` = '0'");
...
$result = $result && mysqli_query($db_link, "UPDATE `b01` SET `B01N03MM`='$payment_final' WHERE `B01I04XA` = '$table_uuid' AND `B01N04IT` = '0'");

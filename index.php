    ...
    <div class="row">
      ...
      <div class="row" style="margin-top: 15px;">
          ...
          <div class="d-flex align-items-start">
            ...
            <div class="tab-content" id="v-pills-tabContent">
              <div class="tab-pane fade show active" id="v-pills-friedNoodles" role="tabpanel" aria-labelledby="v-pills-friedNoodles-tab">
                <button class="btn projectBtn" data-bs-toggle="pill">海鮮炒烏龍 $85</button>
                <button class="btn projectBtn" data-bs-toggle="pill">海鮮炒米粉 $85</button>
        ...
        <center class="col-md-2" style="margin-top: 50px;">
          ...
          <button class="btn addBtn" data-bs-toggle="pill">加大</button>
          <button class="btn addBtn" data-bs-toggle="pill">加辣</button>
          <button class="btn addBtn" data-bs-toggle="pill">招待</button>
        </center>
        <div class="col-md-3" style="color: white;">
          <div style="border: 2px solid #007048;height: 583px;border-radius: 24px;border-radius: 15px;box-shadow: 2px 2px 8px 2px #a4cad9;padding: 50px 30px;background-color: #007048;">
            <ul>
              <li>蝦仁肉絲蛋炒飯</li>
              <li style="float: right;">x1</li>
                <ul>
                  <li style="color: #d2d2d2;">加大，加辣</li>
                  <li style="float: right;color: #dc3545;"><i class="fas fa-trash-alt"></i></li>
                </ul>
            </ul>
            <ul>
              <li>肝連湯</li>
            ...
            <div style="position: relative;top: 335px;">
              ...
              <button type="button" class="btn" style="float: right;background-color: #ebdcc3;color: #007048;margin-top: 4px;"><i class="fas fa-arrow-right"></i></button>
            </div>
          </div>
        </div>
        <div class="col-md-1"></div>
